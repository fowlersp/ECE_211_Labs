...
HD_PWD='C:/Users/horowitj/Documents/Lab_6/Lab_6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log alu_s.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source alu_s.tcl
