...
HD_PWD='C:/Users/horowitj/Documents/lab_4/lab_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab4_toplevel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab4_toplevel.tcl
