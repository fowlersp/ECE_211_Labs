...
HD_PWD='C:/Users/horowitj/Documents/lab_4/lab_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab4_toplevel.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab4_toplevel.tcl -notrace
