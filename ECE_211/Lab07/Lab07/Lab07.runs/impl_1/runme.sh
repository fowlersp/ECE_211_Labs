...
HD_PWD='C:/Users/fowlersp/Documents/ECE_211/Lab07/Lab07/Lab07.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab7_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab7_top.tcl -notrace
