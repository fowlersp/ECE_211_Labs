...
HD_PWD='C:/Users/fowlersp/Documents/ECE_211/lab_5/lab_5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log binary_to_bcd.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source binary_to_bcd.tcl -notrace
