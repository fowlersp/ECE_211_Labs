...
HD_PWD='C:/Users/fowlersp/Documents/ECE_211/lab_5/lab_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log binary_to_bcd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source binary_to_bcd.tcl
