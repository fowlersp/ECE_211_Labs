...
HD_PWD='C:/Users/fowlersp/Documents/ECE_211/final_project/final_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log project_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source project_top.tcl -notrace
